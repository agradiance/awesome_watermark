...
import 'package:awesome_watermark/awesome_watermark.dart';
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
                        ...
                        onPressed: () {
                          ImagePicker().pickVideo(source: ImageSource.gallery).then((value) async {
                            ...
                            if (value != null) {
                              ...
                              await videoPlayerController.initialize().then((video) {
                                setState(() {
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      ...
                                      AwesomeWatermark videoWatermark;

                                      switch (Pages.values[index]) {
                                        case Pages.Watermark:
                                          videoWatermark = AwesomeWatermark(
  ...
  Future<void> generateVideo(AwesomeWatermark videoWatermark) async {
    videoPlayback();
    setState(() {
      loading = true;
    });
